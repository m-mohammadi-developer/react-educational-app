                ...
                <div className="col-md-8 col-sm-12 col-xs-12 pull-left">
                    <section className="term-description">
                        ...
                        <ul>
                            ...
                            <li><h3> پروژه ایجاد یک وب سایت - طراحی دیتابیس </h3> <i> نقدی </i>
                                <span>02:05:12</span></li>
                            <li><h3> پروژه ایجاد یک وب سایت - ایجاد پنل مدیریت </h3> <i> نقدی </i>
                                <span>00:10:12</span></li>
                            <li><h3> چرا شی گرایی یاد بگیریم ؟ </h3> <i> نقدی </i> <span>01:15:12</span></li>
                            <li><h3> پروژه ایجاد یک وب سایت - طراحی دیتابیس </h3> <i> نقدی </i>
                                <span>02:05:12</span></li>
                            <li><h3> پروژه ایجاد یک وب سایت - ایجاد پنل مدیریت </h3> <i> نقدی </i>
                                    ...
                                    <ul className="pagination justify-content-center">
                                        <li className="page-item">
                                            <a className="page-link" href="#" aria-label="Previous">
                                                <span aria-hidden="true"><i
                                                    className="zmdi zmdi-chevron-right"></i></span>
                                            </a>
                                        </li>
                                        ...
                                        <li className="page-item">
                                            <a className="page-link" href="#" aria-label="Next">
                                                <span aria-hidden="true"><i
                                                    className="zmdi zmdi-chevron-left"></i></span>
                                            </a>
                                        </li>
                                    </ul>
                                </nav>
